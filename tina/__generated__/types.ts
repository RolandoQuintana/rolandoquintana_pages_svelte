...
export type DocumentNode = Page | Project | Skill | Folder;
...
export type SkillQuery = { __typename?: 'Query', skill: { __typename: 'Skill', id: string, title: string, category: string, proficiency: number, icon?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } };
...
export type SkillConnectionQuery = { __typename?: 'Query', skillConnection: { __typename?: 'SkillConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor: string, endCursor: string }, edges?: Array<{ __typename?: 'SkillConnectionEdges', cursor: string, node?: { __typename: 'Skill', id: string, title: string, category: string, proficiency: number, icon?: string | null, _sys: { __typename?: 'SystemInfo', filename: string, basename: string, hasReferences?: boolean | null, breadcrumbs: Array<string>, path: string, relativePath: string, extension: string } } | null } | null> | null } };
